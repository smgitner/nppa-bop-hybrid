<?php
/**
 * The template for displaying all single opvi posts - updated in 2025
 *
    ...
    <?php while ( have_rows( 'first_place_group' ) ) : the_row(); ?>
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center; align-items: stretch;">
            ...
            foreach ($video_links as $video_link) :
                ...
                if ($video) :
            ?>
                <div style="flex: 0 1 300px; max-width: 300px; height: auto;">
...
<?php if ( have_rows( 'third_place_group' ) ) : ?>
    <?php while ( have_rows( 'third_place_group' ) ) : the_row(); ?>
        ...
        <div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center; align-items: stretch;">
            <?php 
            $video_links = [
                'threep_videolink_one',
                'threep_videolink_two',
                'threep_videolink_three',
                'threep_videolink_four',
                'threep_videolink_five'
            ];
