<?php
/**
 * The template for displaying all single videoediting posts
 *
  ...
  <?php if ( have_rows( 'hm_place_winner_2' ) ) : ?>
    ...
    <div class="c-winner-video w-container">
      ...
      <div class="d-byline-caption">
        ...
        <div class="d-byline-title">
          <div class="nameandorg"><?php the_sub_field( 'hm_firstname_2' ); ?> <?php the_sub_field( 'hm_lastname_2' ); ?><?php if( get_sub_field('hm_lastname_1') ): ?>/<?php endif; ?><span class="organization"><?php the_sub_field( 'hm_publication_2' ); ?></span></div>
        </div>
      </div>
    </div>
  </div>
