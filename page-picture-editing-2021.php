...
<div class="s-headline-dek">
    <div class="container-header story-container w-container">
      <div class="header-div">
        ...
        <?php
        $loop = new WP_Query( array( 'post_type' => 'pictureediting', 'posts_per_page' => 50 ) );
          ...
          <div class="flex-container w-container">
            <!-- <div class="feature-image-mask">
              ...
              <a href="<?php echo get_permalink(); ?>">
                <?php the_post_thumbnail('thumbnail', array('class' => 'feature-image')); ?>
                </a>

            </div> -->
            <div>
              <h2 class="category-meta-2">Picture Editing</h2>
