      ...
      <div class="c-navbop w-container">
        <div class="c-bopbrand w-container">
          <div class="d-bopbrand">
            <a href="<?php echo get_option("siteurl"); ?>" class="brand-bop w-nav-brand">

              <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/bop_logo_white.png" loading="lazy" width="92" alt="" class="image-boplogo">
